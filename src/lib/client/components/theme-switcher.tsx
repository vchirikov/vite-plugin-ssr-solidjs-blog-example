...
export const ThemeSwitcher: Component = () => {
  if (isBrowser) {
    createEffect(() => {
      ...
      if (isFirstRun) {
        isFirstRun = false;
        // TODO: create a service to abstract window.localStorage
        const stored = window.localStorage.getItem('theme') as Theme | undefined;
        if (stored && stored != theme()) {
          setTheme(stored);
        }
      }
      // injects data-theme into html tag
      // TODO: create a service to abstract access to html tag ?
